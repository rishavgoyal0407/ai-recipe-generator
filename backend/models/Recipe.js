...
class Recipe {
    ...
    static async create(userId, recipeData) {
        // Get a dedicated DB connection from the pool (required for transactions/multiple queries). Always release it after use.
        ...
        try {
            ...
            const {
                name, description, cuisine_type, difficulty, prep_time, cook_time, servings, instructions, dietary_tags = [], user_notes, image_url, ingredients = [], nutrition = {}
            } = recipeData;
            ...
            //Object.keys(obj) returns an array of the object's keys, and .length > 0 checks if any keys exist.
            ...
            //When an error occurs: ostgreSQL removes everything done after BEGIN
    ...
    static async update(id, userId, updates) {
        const {
            name, description, cuisine_type, difficulty, prep_time, cook_time, servings, instructions, dietary_tags, user_notes, image_url
        } = updates;
